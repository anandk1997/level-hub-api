...
module.exports = {
    ...
    PLANS_DEFAULT_SUCCESS: 'Deafult plan created successfully.',
    PLANS_CREATE_SUCCESS: 'Plans created successfully.',
    PLAN_EXISTS: 'A plan with same name already exists!',
    PLAN_EXISTS_EXCEPTION: 'PlanExistException',
    PLAN_FETCH_SUCCESS: 'Plan details fetched successfully.',
    PLAN_DOESNT_EXISTS: "Plan doesn't exist!",
    PLAN_DOESNT_EXCEPTION: "PlanNotExistsException",
    PLAN_ACTIVATE_SUCCESS: 'Plan activated successfully.',
    PLAN_DEACTIVATE_SUCCESS: 'Plan deactivated successfully.',
    PLANS_UPDATE_SUCCESS: 'Plans updated successfully.',
    PLANS_UPDATE_ERROR: 'Error while updating plan. Please try again in sometime.',
}
